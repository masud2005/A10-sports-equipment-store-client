          ...
          <div className="bg-gradient-to-tr from-indigo-50 via-purple-50 to-teal-50 p-5 rounded-lg">
            <form ref={form} onSubmit={sendEmail} className="space-y-4">
              <input
                ...
                className="w-full px-4 py-3 border border-purple-300 rounded-lg placeholder-gray-500 text-white outline-none focus:ring-1 focus:ring-blue-500"
                required
              />
              <input
                type="email"
              ...
              <button
                type="submit"
                className="w-full py-3 bg-purple-500 border border-purple-500 hover:bg-transparent text-white hover:text-black transition rounded-lg font-semibold"
              >
                SEND MESSAGE
              </button>
            </form>
